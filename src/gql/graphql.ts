...
export type CollectionGetByNameQuery = { collections: Array<{ products: Array<{ id: string, name: string, description: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> }> };

export type ColorsGetListQueryVariables = Exact<{ [key: string]: never; }>;


export type ColorsGetListQuery = { productColorVariants: Array<{ color: ProductColor }> };
...
export type ProductGetRelatedQuery = { products: Array<{ id: string, name: string, description: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> };
...
export type ProductsGetBySearchQuery = { products: Array<{ id: string, name: string, description: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> };

export type SizesGetListQueryVariables = Exact<{ [key: string]: never; }>;


export type SizesGetListQuery = { productSizeVariants: Array<{ size: ProductSize }> };
